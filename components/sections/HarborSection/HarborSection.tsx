...
const translations = {
  en: {
    ...
    copy4:
      "And when the time comes to add something new, the Market Hall offers a quieter way to buy — carefully selected, clearly described and chosen with collectors in mind.",
  ...
  nl: {
    ...
    copy4:
      "En wanneer het tijd is om iets nieuws aan je collectie toe te voegen, biedt de Market Hall een rustigere manier om te kopen — zorgvuldig geselecteerd, helder beschreven en gekozen met verzamelaars in gedachten.",
